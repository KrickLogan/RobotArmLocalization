...
# This file demonstrates how to use the system in the simplest way. This code cannot
# be run until the calibration has been run and there is a rotation folder inside the
# users working directory. If the Rotation is present, the user can submit an image 
# and depth array and the system will return the position of the object in the robot
